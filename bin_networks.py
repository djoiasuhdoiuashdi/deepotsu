...
def build_input_desnet(inputs, numblock):
    netlist = []
    net = inputs
...
def buildfusion_desnet(inputs, numblock):
    netlist = []
    mid_netlist = []
    net = inputs
    for n in range(numblock):
...
def buildfusion_denselynet(inputs, numblock):
    netlist = []
    net = inputs
    for n in range(numblock):
        with tf.compat.v1.variable_scope('block'+str(n)):
...
def build_des_net(inputs, numblock):
    netlist = []
    net = inputs
    for n in range(numblock):
        with tf.compat.v1.variable_scope('block'+str(n)):
...
def build_hed_unet(inputs, numblock):
    netlist = []
    side_net_list = []
    net  = inputs
    for n in range(numblock):
